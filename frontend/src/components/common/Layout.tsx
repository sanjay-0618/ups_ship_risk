          ...
          <div className="flex items-center flex-1">
            ...
            <div className="relative w-full max-w-md hidden md:block">
              ...
              <input 
                ...
                className="w-full pl-9 pr-12 py-1.5 text-xs bg-slate-100/80 border border-slate-200/60 rounded-xl focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all placeholder:text-slate-400"
              />
              <span className="absolute right-2.5 top-1/2 -translate-y-1/2 text-[10px] font-mono text-slate-400 border border-slate-200 px-1.5 py-0.5 rounded-md bg-white shadow-2xs">
                ⌘K
              </span>
            </div>
          </div>
